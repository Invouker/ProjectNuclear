package eu.invouk.projectnuclear.gui.menu;

import eu.invouk.projectnuclear.register.ModBlocks;
import eu.invouk.projectnuclear.register.ModMenuTypes;
import eu.invouk.projectnuclear.tile.CoalGeneratorTile;
import eu.invouk.projectnuclear.utils.SlotBurnable;
...
public class CoalGeneratorMenu extends AbstractContainerMenu {
   ...
   public final CoalGeneratorTile blockEntity;
   ...
   private final ContainerData containerData;
    ...
    public CoalGeneratorMenu(int id, Inventory inventory, BlockEntity entity, ContainerData containerData) {
        ...
        this.addSlot(new SlotBurnable(blockEntity.getItemHandler(), 0,25, 33));
    ...
    public boolean stillValid(Player player) {
        return AbstractContainerMenu.stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.COAL_GENERATOR.get());
    }
